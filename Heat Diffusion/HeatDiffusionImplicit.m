...
% 1-dimensional heat diffusion equation using an implicit formulation
...
for i=1:numberOfTimeSteps
    if(i==1)
        ...
        temperatureVectorTp1 = pinv(A) * temperatureVectorT; % Forecast temperature distribution at t+1
        temperatureVectorTp1(1) = temperatureLeftSide;
        temperatureVectorTp1(end) = temperatureRightSide;        
    end
